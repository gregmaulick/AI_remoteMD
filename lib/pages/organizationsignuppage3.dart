...
class OrganizationSignUpPage3 extends StatefulWidget {
  final String user;
  const OrganizationSignUpPage3({Key key, @required this.user})
      : super(key: key);

  @override
  _OrganizationSignUpPage3State createState() =>
      _OrganizationSignUpPage3State();
...
//            || value.length < 6
  ...
  void _submitForm() {
    ...
    gUser = setUser;
    gUserType = UserType.organization;
